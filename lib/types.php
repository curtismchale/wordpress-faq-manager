...
class WPFAQ_Manager_Types
{
	...
	public function _register_post_type()
	{
		...
		// Set my labels first.
		$labels = array(
			'name'                => __('FAQs', 'easy-faq-manager'),
			'singular_name'       => __('FAQ', 'easy-faq-manager'),
			'add_new'             => __('Add New FAQ', 'easy-faq-manager'),
			'add_new_item'        => __('Add New FAQ', 'easy-faq-manager'),
			'edit'                => __('Edit', 'easy-faq-manager'),
			'edit_item'           => __('Edit FAQ', 'easy-faq-manager'),
			'new_item'            => __('New FAQ', 'easy-faq-manager'),
			'view'                => __('View FAQ', 'easy-faq-manager'),
			'view_item'           => __('View FAQ', 'easy-faq-manager'),
			'search_items'        => __('Search FAQ', 'easy-faq-manager'),
			'not_found'           => __('No FAQs found', 'easy-faq-manager'),
			'not_found_in_trash'  => __('No FAQs found in Trash', 'easy-faq-manager'),
		);
	...
	public function _register_tax_topics()
	{
		...
		// Set my labels first.
		$labels = array(
			'name'              => __('FAQ Topics', 'easy-faq-manager'),
			'singular_name'     => __('FAQ Topic', 'easy-faq-manager'),
			'search_items'      => __('Search FAQ Topics', 'easy-faq-manager'),
			'popular_items'     => __('Popular FAQ Topics', 'easy-faq-manager'),
			'all_items'         => __('All FAQ Topics', 'easy-faq-manager'),
			'parent_item'       => __('Parent FAQ Topic', 'easy-faq-manager'),
			'parent_item_colon' => __('Parent FAQ Topic:', 'easy-faq-manager'),
			'edit_item'         => __('Edit FAQ Topics', 'easy-faq-manager'),
			'update_item'       => __('Update FAQ Topics', 'easy-faq-manager'),
			'add_new_item'      => __('Add New FAQ Topic', 'easy-faq-manager'),
			'new_item_name'     => __('New FAQ Topics', 'easy-faq-manager'),
		);
	...
	public function _register_tax_tags()
	{
		...
		$labels = array(
			...
			'edit_item'                  => __('Edit FAQ Tag', 'easy-faq-manager'),
			'update_item'                => __('Update FAQ Tag', 'easy-faq-manager'),
			'add_new_item'               => __('Add New FAQ Tag', 'easy-faq-manager'),
			'new_item_name'              => __('New FAQ Tag Name', 'easy-faq-manager'),
			'separate_items_with_commas' => __('Separate FAQ tags with commas', 'easy-faq-manager'),
			'add_or_remove_items'        => __('Add or remove FAQ tags', 'easy-faq-manager'),
			'choose_from_most_used'      => __('Choose from the most used FAQ tags', 'easy-faq-manager'),
			'not_found'                  => __('No FAQ tags found.', 'easy-faq-manager'),
			'menu_name'                  => __('FAQ Tags', 'easy-faq-manager'),
		);
